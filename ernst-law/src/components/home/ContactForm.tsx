...
export default function ContactForm() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      // Send via mailto as fallback (no server needed)
    ...
    <section className="py-20 md:py-28 relative" id="contact">
      <div className="section-container">
        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10 max-w-2xl mx-auto">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-sm" style={{ color: '#F5F0EB', fontFamily: 'var(--font-frank)' }}>
                  קביעת פגישה
                </p>
        ...
        <div className="flex items-center gap-4 mb-8 max-w-2xl mx-auto">
          <div className="flex-1 h-[1px]" style={{ backgroundColor: 'rgba(255,255,255,0.07)' }} />
          <span className="text-xs" style={{ color: 'rgba(200,169,110,0.5)', fontFamily: 'var(--font-frank)' }}>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        <input
                          ...
                          onFocus={(e) => { e.currentTarget.style.borderColor = 'var(--color-primary-400)' }}
                          onBlur={(e) => { if (!errors.phone) e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)' }}
                        />
                      </div>
                    </div>
                    ...
                    >
                      ...
                      {t.contact.form.subjects.map((subject, i) => (
                        <option key={i} value={subject} style={{ backgroundColor: '#1A2634' }}>
                          {subject}
                        </option>
                      ))}
                    </select>
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              {t.contact.offices.map((office, i) => (
                <div key={i} className="premium-card">
                  <span
                    className="text-xs font-medium px-2 py-1 rounded-md mb-2 inline-block"
                    style={{
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="text-cream-200/80 text-sm" dir="ltr">{PHONE_NUMBER}</span>
                </a>
                <a
                ...
                >
                  ...
                  <span className="text-cream-200/80 text-sm">office@ernstlaw.co.il</span>
                </a>
              </div>
            </div>
          </div>
